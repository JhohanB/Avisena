...
from app.router import auth, users, estate, chickens, isolation, type_chickens, chicken_incident, rescue, sheds
...
app.include_router(estate.router, prefix="/estate", tags=["fincas"])
app.include_router(sheds.router, prefix="/sheds", tags=["galpones"])
